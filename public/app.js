...
var ajaxService = function ajaxService(term) {
  ...
  return fetch("".concat(url).concat(term, "/images")).then(function (responce) {
...
var form = function form() {
  return "<div class=\"form-group mb-2\">\n    <input type=\"text\"  class=\"form-control term\" placeholder=\"Sunu veisle\">\n</div>\n\n<button type=\"submit\" class=\"btn btn-primary\">Ieskoti bb</button>\n<div class=\"result\">\n\n</div>\n    ";
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (form); //<img src="searchCode.js" class="form-control result" display>
...
var searchCode = function searchCode() {
  document.querySelector('form').addEventListener('submit', function (e) {
    ...
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm).then(function (result) {
      ...
      return console.log(searchResponce.message[0]);
    }).then(function () {
      return document.querySelector('.result').value = searchResponce.message[0];
    });
  });
};
